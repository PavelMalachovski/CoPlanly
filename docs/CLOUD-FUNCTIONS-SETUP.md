# Руководство по настройке Cloud Functions для CoParently

## Обзор

Cloud Functions автоматически обрабатывают push-уведомления и другие серверные задачи для приложения CoParently.
